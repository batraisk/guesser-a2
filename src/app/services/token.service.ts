...
export class Angular2TokenService implements CanActivate {
    ...
    registerAccount(registerData: RegisterData): Observable<Response> {
        ...
        console.log('1');
        console.log(this._getUserPath() + this._options.registerAccountPath);
        console.log('2');
        console.log(body);
        ...
        // this._http
        //        .post(this._getUserPath() + this._options.registerAccountPath,
        //              body,
        //              {headers: new Headers(this._options.globalOptions.headers)})
        //        .toPromise()
        //        .then(response => {
        //          console.log('7');
    ...
    console.log('An error occurred7', error); // for demo purposes only
    ...
    post(url: string, body: any, options?: RequestOptionsArgs): Observable<Response> {
        console.log('3');
        console.log(this._mergeRequestOptionsArgs({
            url:    this._getApiPath() + url,
    ...
    //            .post(options.url,
    //                  JSON.stringify(options.body),
    //                  {headers: options.headers}).subscribe(
    //   res =>      console.log(res),
